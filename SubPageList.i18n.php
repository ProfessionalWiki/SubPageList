...
$messages['mk'] = array(
	...
	'spl-subpages-par-page' => 'За која страница да се прикажат потстраниците (по основно - тековната страница).',
	'spl-subpages-par-showpage' => 'Назначува дали во списокот да се прикаже и самата страница.',
	'spl-subpages-par-pathstyle' => 'Стилот на патеката за потстраниците во списокот.',
