...
$messages['fa'] = array(
	...
	'spl-subpages-par-links' => 'اگر درست باشد، موارد فهرست به عنوان لینک ها ارائه شده‌اند. اگر نادرست باشد، موارد فهرست به عنوان متن ساده ارائه شده‌اند. دومی مخصوصاً برای عبور از موارد در الگوها برای پردازش بیشتر مفید است.',
);
