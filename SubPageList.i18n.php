...
$messages['be-tarask'] = array(
	...
	'spl-subpages-par-element' => 'Элемэнт HTML, які ўлучае сьпіс (разам з тэкстамі "intro" і "outro" або "default"). Дапушчальныя значэньні: "div", "p", "span".',
	'spl-subpages-par-class' => 'Значэньні атрыбуту «class» закрываючага сьпіс элемэнту HTML.',
	'spl-subpages-par-intro' => 'Тэкст для вываду перад сьпісам, калі той не пусты.',
	'spl-subpages-par-outro' => 'Тэкст для вываду пасьля сьпісам, калі той не пусты.',
	...
	'spl-subpages-par-template' => 'Назва шаблёну. Шаблён прымяняецца да кожнага элемэнту сьпісу. Элемэнт перадаецца як першы (безнайменны) аргумэнт. Заўважце, што шаблён не скасоўвае фарматаваньне сьпісу. Фарматаваньне («ul», «ol», «list») ўжываецца да вынікаў шаблёну.',
	'spl-subpages-par-links' => 'Калі сапраўдна, дык элемэнты сьпісу выводзяцца як спасылкі. Калі несапраўдна, выводзяцца як звычайны тэкст. Апошняе асабліва зручна для перадачы элемэнтаў у шаблёны для далейшае апрацоўкі.',
);
